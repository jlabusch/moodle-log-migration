...
function make_alias(this_action, from_action){
    return () => {
...
var library = {
    "add post": {
        ...
        */
        ...
        fixer: function(log_row, old_matches, new_matches){
            if (new_matches.length < 3){
                // Two posts with the same timestamp? Close enough.
    ...
    "update post": {
        alias: make_alias('update post', 'add post')
    },
    "delete post": {
        /*
        +--------+------+-------------+-------------------+------+
        ...
        */
        ...
        fixer: function(log_row, old_matches, new_matches){
            if (bogus_email(log_row.email)){
                return new_matches[new_matches.length-1];
            }
            /*
            Good luck lol
            ...
            +------+--------+-------+--------------------------------------+-----------+--------+---------+----------+--------------+--------------+-----------+---------+
            | 5498 |     20 |    75 | hi guys are you ready for Barcelona? |     21018 |   1380 |      -1 |        1 |   1349793538 |         1385 |         0 |       0 |
            | 5499 |     20 |    75 | hi guys are you ready for Barcelona? |     21019 |   1380 |      -1 |        1 |   1349733913 |         1380 |         0 |       0 |
            | 5500 |     20 |    75 | hi guys are you ready for Barcelona? |     21020 |   1380 |      -1 |        1 |   1349734058 |         1380 |         0 |       0 |
            | 5501 |     20 |    75 | hi guys are you ready for Barcelona? |     21021 |   1380 |      -1 |        1 |   1349734069 |         1380 |         0 |       0 |
            */
            return new_matches[new_matches.length-1]; // Return the latest discussion #yolo
        },
    ...
    "delete discussion": {
        ...
        */
        ...
        fixer: function(log_row, old_matches, new_matches){
            return fix_by_shadow_index(log_row, old_matches, new_matches, (lr,om) => {return lr.cmid === om.cmid});
        },
    ...
    "view discussion": {
        ...
        */
        ...
        fixer: function(log_row, old_matches, new_matches){
            return fix_by_shadow_index(log_row, old_matches, new_matches, (lr,om) => {return lr.info == om.did});
        },
    ...
    "update": {
        alias: make_alias("update", "view forum"),
    },
    "view forum": {
        /*
...
function fix_by_shadow_index(log_row, old_matches, new_matches, cmp){
